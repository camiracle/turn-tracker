...
module.exports = {
    en: {
        translation: {
            WELCOME_MSG: 'Welcome to turn tracker',
            HELLO_MSG: 'Hello World!',
            HELP_MSG: 'Say add person, start turns, or ask whose turn is it.',
            GOODBYE_MSG: 'Goodbye!',
            REFLECTOR_MSG: 'You just triggered {{intentName}}',
            FALLBACK_MSG: 'Sorry, I don\'t know about that. Please try again.',
            ERROR_MSG: 'Sorry, I had trouble doing what you asked. Please try again.',
            TURN_ORDER_MSG: 'Today, the turn order is: {{turnOrder}}',
            TURN_ORDER_NO_USERS_MSG: 'You need to add people first',
            NEW_TURN_ORDER_MSG: 'After rotating, the new turn order is: {{turnOrder}}',
            ALREADY_ROTATED_MSG: 'Turns were already rotated today, silly',
            USER_ADDED_MSG: '{{personName}} was added to the people list'
        }
    },
    es: {
        translation: {
